...
class Chain2HeaderData():
	def __init__(self):
		...
		self.calculateMode = 3#ENUM
		self.chainAttrFlags = 4#ENUM
		self.parameterFlag = 0#ENUM
		self.calculateStepTime = 2.0
		self.modelCollisionSearch = 1#BOOL
		...
		self.highFPSCalculateMode = 2#ENUM, WILDS
		self.wilds_unkn1 = 1
		self.wilds_unkn2 = 1
		self.padding0 = 0
		self.padding1 = 0
...
class Chain2SettingsData():
	def __init__(self):
		...
		self.colliderFilterInfoPath = "System/Collision/Filter/Character/Character_Chain.cfil"
		self.id = 0
		self.settingsAttrFlags = 0 #ENUM
		self.springCalcType = 0
		self.windID = 0
		self.windDelayType = 1
		self.gravityX = 0.0
		self.gravityY = -9.8
		self.gravityZ = 0.0
		...
		self.groupDefaultAttr = 65536#ENUM
